...
if st.session_state.current_question_index < len(questions):
    ...
    st.session_state.demographics['Gender Identity'] = st.selectbox("Which of these best describes your current gender identity?", [
    ...
    st.session_state.demographics['Age'] = st.selectbox("Age", [
    ...
    st.session_state.demographics['Ethnicity'] = st.selectbox("Which best describes you?", [
